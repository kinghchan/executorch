...
#import <executorch/sdk/bundled_program/bundled_program.h>
#import <executorch/extension/data_loader/buffer_data_loader.h>
...
static int debug_buffer_size = 262144;
static bool dump_outputs = false;
static bool dump_intermediate_outputs = false;
static int testset_idx = 0;
static bool output_verification = true;
static bool print_output = true;
static std::string debug_output_path = "debug_output.bin";
static std::string etdump_path = "etdump.etdp";
